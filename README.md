...
- **Paper**: On the Power of Decision Trees in Auto‑Regressive Language Modeling.  [Link](https://arxiv.org/abs/XXXX)  (replace with the actual link).


## License

MIT‑style (adapt to whatever license you use).
